...
```
RPN = S × O × D  (传音企业 1-5 分制 · Transsion 1-5 scale)
...
本 Skills 集为内部可靠性评审工具，版权归 **深圳传音控股股份有限公司** 所有。

This Skills collection is an internal reliability review tool, copyright **Transsion Holdings**.
